...
<div class="card">
  ...
  <div class="creds">
    ...
    <div class="cr"><span class="cl">URL</span><span class="cv">/gigghana/admin/login.php</span></div>
  ...
  <div class="btns">
    <a href="/gigghana/admin/login.php" class="btn btn-go">🛡 Go to Admin Login →</a>
...
if (isset($_GET['delete']) && $allGood) {
    if (@unlink(__FILE__)) echo '<script>alert("Deleted! Redirecting..."); window.location="/gigghana/admin/login.php";</script>';
