...
export const testimonialFallbacks = [
  {
    first_name: 'Kwame',
    last_name: 'Asante',
    trade: 'Master Artisan',
    payout_proof: 'Escrow Protected',
    comment: "The escrow gave me complete peace of mind. Payment landed instantly right after inspection.",
    rating_overall: 5,
    role: 'provider',
    location: 'Accra',
    avatar: '/images/avatars/avatar_male_1.jpg',
  },
  {
    first_name: 'Abena',
    last_name: 'Osei-Mensah',
    trade: 'Verified Client',
    payout_proof: 'Milestone Completed',
  ...
  },
  {
    ...
    trade: 'Master Artisan',
    payout_proof: 'Escrow Protected',
    comment: "Best platform for genuine artisans. Funds are secured before you even begin the job.",
    rating_overall: 5,
    role: 'provider',
    location: 'Takoradi',
    avatar: '/images/avatars/avatar_male_2.jpg',
  },
  {
    first_name: 'Ama Serwaa',
    last_name: 'Darko',
    trade: 'Master Specialist',
    payout_proof: 'Milestone Completed',
    comment: "Managing care contracts from abroad has never been this smooth and trustworthy.",
    rating_overall: 5,
    role: 'provider',
    location: 'Accra',
    avatar: '/images/avatars/avatar_female_3.jpg',
  },
  {
    first_name: 'Akosua',
    last_name: 'Mensah',
    trade: 'Verified Client',
    payout_proof: 'Escrow Protected',
    comment: "Clients trust me faster now because my profile is fully biometric verified.",
    rating_overall: 5,
    role: 'client',
    location: 'Accra',
  ...
  },
  {
    ...
    trade: 'Verified Client',
    payout_proof: 'Milestone Completed',
    comment: "Milestone escrow eliminated construction disputes. Work gets checked before release.",
    rating_overall: 5,
    role: 'client',
    location: 'Accra',
    avatar: '/images/avatars/avatar_male_3.jpg',
  },
];
