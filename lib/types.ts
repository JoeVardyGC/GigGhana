...
export const fallbackFeaturedProviders = [
  {
    ...
    cat_id: 'tech',
    cat_name: 'Technology',
    skills: ['React', 'Mobile Apps', 'Backend'],
    initials: 'KM',
    avatar: '',
  },
  {
    ...
    first_name: 'Kofi',
    last_name: 'Asare',
    role_title: 'Professional Painter',
    tagline: 'Professional Painter',
    location: 'Kumasi',
  ...
  },
  {
    ...
    first_name: 'Kwame',
    last_name: 'Asante',
    role_title: 'Interior Plasterer',
    tagline: 'POP Ceiling Designer',
    ...
    cat_id: 'home',
    cat_name: 'Home Services',
    skills: ['POP Ceilings', 'Interior Lighting'],
    initials: 'KA',
    avatar: '',
  },
  {
    ...
    first_name: 'Emmanuel',
    last_name: 'Yeboah',
    role_title: 'Architectural Consultant',
    ...
    cat_id: 'business',
    cat_name: 'Business',
    skills: ['AutoCAD', 'Building Permits'],
    initials: 'EY',
    avatar: '',
  },
  {
    ...
    last_name: 'Klutse',
    role_title: 'Ergonomic Consultant',
    tagline: 'Ergonomic Consultant',
    ...
    cat_id: 'business',
    cat_name: 'Business',
    skills: ['Ergonomics', 'Physiotherapy'],
    initials: 'SK',
    avatar: '',
  }
];
